          ...
          <div className="col-span-12 lg:col-span-7">
            ...
            <p className="mb-6 max-w-2xl font-light text-gray-500 dark:text-gray-400 md:text-lg lg:mb-8 lg:text-xl">
              ...
              <div className="text-center py-4 lg:px-4">
                <div className="p-2 bg-red-300 items-center text-red-100 leading-none lg:rounded-full flex lg:inline-flex" role="alert">
                  <span className="flex rounded-full bg-red-500 uppercase px-2 py-1 text-xs font-bold mr-3">Figyelem!</span>
                  <span className="font-semibold mr-2 text-left flex-auto text-red-800">Október 27.-ig csak emailen vagyunk elérhetőek!</span>
