        ...
        <div className="mx-auto max-w-7xl items-center gap-16 px-8 py-12 lg:px-20 lg:py-16 xl:grid xl:grid-cols-2">
          <div className="font-light text-gray-600 dark:text-gray-400 sm:text-lg">
            ...
            <p>
              ...
              <br></br> A szalagavató jelvény ára egyenesvágással 550 Ft/db, 590 Ft/db cikkcakk vágással. Az ár nem tartalmazza
              az áfá-t. <br></br>
              <br></br>Ha átutalással kéri a fizetést, kérjük, hogy megrendeléskor ezt előre jelezze és adja meg a számlázási címet. Előleget nem kérünk.
              <br></br>
